...
import 'package:eyepetizer_flutter/common/common.dart';
import 'package:flutter/material.dart';

class Log {

  static const String tag = 'INFO_LOG';
...
class LogUtil {
  ...
  static const String _TAG_DEF = "COMMON_LOG";

  static bool debuggable = false; //是否是debug模式
